...
const BeautyReviewerSection = () => {
  return (
    <Container>
      <Grid className="grid-cols-1 md:grid-cols-2  md:mt-0 gap-4">
        <div className="">
          <p className="text-[32px] md:text-[42px] lg:text-[54px] xl:text-[64px] font-bold text-gray-900 leading-[120%]">
            <span className="text-gray-400">Chỉ cần yêu thích làm đẹp,</span> ai
            cũng có thể trở thành Reviewer!
          </p>
        </div>
        <div className="">
          <div className="space-y-2 mt-6 md:mt-0 text-[16px] md:text-[18px] lg:text-[24px] text-gray-700">
            <p className="">
