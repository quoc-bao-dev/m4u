...
// Animation configuration for this component
const ANIMATION_CONFIG = {
  blur1: {
    initial: { x: -15, y: -10, rotate: 0 },
    animate: { x: [-15, 15, -15], y: [-10, 10, -10], rotate: [0, 6, 0] },
    transition: {
      duration: 4,
      repeat: Infinity,
    },
  ...
  blur2: {
    initial: { x: 10, y: -12, rotate: 0 },
    animate: { x: [10, -20, 10], y: [-12, 12, -12], rotate: [0, -8, 0] },
    transition: {
      duration: 4,
      repeat: Infinity,
    },
