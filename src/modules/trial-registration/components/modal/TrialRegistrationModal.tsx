...
const TrialRegistrationModal = () => {
  const { isOpen, open: onpen, close, productId, productImage, productName, productBrand, productColor } = useModalRegistration()
      ...
      >
        <div className="w-full h-full relative p-8 rounded-4xl overflow-hidden">
          ...
          <div className="h-full md:grid lg:grid-cols-2 gap-10 relative z-10">
            <div
              className={cn(
                'w-full h-full xl:aspect-[7/9] hidden lg:block  max-h-max md:max-h-[600px]',
            ...
            <div
              className={cn(
                'h-full max-h-max  md:max-h-[600px] ',
                height < 768 &&
