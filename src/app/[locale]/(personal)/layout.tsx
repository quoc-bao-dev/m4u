...
const configPath = ['my-reviews']

const Layout = ({ children }: PropsWithChildren) => {
  const pathname = usePathname()
  const isScroll = configPath.some((path) => pathname?.includes(path))
  return (
        ...
        <Container>
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 lg:gap-6 relative z-10">
            ...
            <section className="lg:col-span-8 xl:col-span-9">
              <div
                className={`lg:p-5 lg:bg-white lg:rounded-2xl lg:shadow-[0px_4px_24px_0px_#0000000F] ${
                  isScroll
