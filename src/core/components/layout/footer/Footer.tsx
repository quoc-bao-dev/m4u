        ...
        <div className="flex flex-col gap-10 md:gap-24">
          ...
          <div className='flex flex-col gap-4'>
            ...
            <div className='flex items-end gap-2'>
              <p className='text-sm text-white font-bold font-charm'>Là một hệ sinh thái của</p>
              <Link href="https://www.romana.vn/" target='_blank'>
                <Image src="/image/layout/romana.png" alt="logo" width={100} height={100} className='mb-[-8px]' />
              </Link>
            </div>
          </div>
...
const SocialLink = ({ info }: { info: any }) => {
  return (
    <div className="hidden md:flex items-center gap-4">
      {/* TODO: map social */}
      <a
      ...
      >
        <img src="/image/icon/shopee.png" alt="" className="size-[20px]" />
      </a>
    </div>
  )
}
